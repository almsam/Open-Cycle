  ...
  return (
    <div>
      <div className={isAndroid ? "flex flex-col" : "flex items-start"}>
        <Card className={`border-[2px] border-[#a30262] w-full ${isAndroid ? "order-last" : "max-w-[560px] mx-auto p-6  mb-8" }`}>
            <Calendar
            mode="single"
        ...
        <Card className={`border-[2px] border-[#00bfff] ${isAndroid ? "order-first" : "ml-6 w-96 ..."}`}>
